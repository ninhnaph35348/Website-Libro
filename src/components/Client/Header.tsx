...
const Header = () => {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === "Enter") {
      e.preventDefault(); 
      navigate(`/shop?s=${encodeURIComponent(keyword)}`);
    }
  }
                ...
                <div className="col-6 col-md-6 col-lg-2 col-xl-4 col-xxl-2">
                  <div className="header-right">
                    <div className="category-oneadjust gap-6 d-flex align-items-center">
                      <form className="search-toggle-box d-md-block" onSubmit={(e) => e.preventDefault()}>
                        <div className="flex items-center bg-white rounded-full overflow-hidden shadow-md transition duration-300 focus-within:shadow-lg">
                          ...
                          />
                          <button className="p-3 rounded-full hover:bg-gray-200 transition duration-300" onClick={handleSearchClick}>
