    ...
    <div className="breadcrumb-wrapper">
      ...
      <div className="container">
          ...
          <div className="page-nav-wrap text-center wow fadeInUp" data-wow-delay=".3s">
              <ul>
                  <li><a className="previous" href="news-grid.html">Previous</a></li>
                  <li><a className="page-numbers" href="news-grid.html">1</a></li>
                  <li><a className="page-numbers" href="news-grid.html">2</a></li>
                  <li><a className="page-numbers" href="news-grid.html">3</a></li>
                  <li><a className="page-numbers" href="news-grid.html">...</a></li>
                  <li><a className="next" href="news-grid.html">Next</a></li>
              </ul>
          </div>
      </div>
  </section>
