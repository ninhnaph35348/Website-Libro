                        ...
                        paginatedProducts.map((product: IProduct, index: number) => (
                            <tr key={product.id ?? index} className="border">
                                ...
                                <td className="border p-2 text-center">
                                    <img className="w-20 h-20" src={`http://127.0.0.1:8000/storage/` + product.image} alt="No" />
                                </td>
                                <td className="h-auto p-2 space-x-2 text-center min-w-32">
                                    ...
                                    <button onClick={() => navigate(`edit/${product.code}`)} className="bg-yellow-500 text-white px-2 py-1 rounded">
                                        Sửa
                                    </button>
                                </td>
                            </tr>
