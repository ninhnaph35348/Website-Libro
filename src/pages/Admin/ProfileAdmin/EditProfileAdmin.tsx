...
const EditProfileAdmin: React.FC = () => {
  ...
  const handleChange = (
    ...
    if (name === "province") {
      ...
      setUserData({
        ...
        address: `${
          userData?.province
            ? provinces.find((p) => p.code === userData?.province)?.name
            : ""
      ...
      setUserData({
        ...
        address: `${
          ...
          userData?.district
            ? districts.find((d) => d.code === userData?.district)?.name
            : ""
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 bg-white shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* <div>
          ...
          >
            ...
            {districts
              .filter((d) => d.provinceCode === userData?.province)
              .map((d) => (
        ...
        {/* <div className="col-span-2">
          ...
          >
            ...
            {wards
              .filter((w) => w.districtCode === userData?.district)
              .map((w) => (
      ...
      <div className="flex justify-end gap-4 mt-6">
        ...
        <button
          onClick={() => navigate("/admin/profile-Admin")}
          className="px-5 py-3 bg-gray-300 rounded"
        >
          Hủy
        </button>
      </div>
