...
const Author = () => {
  ...
  return (
    <div className="p-6 w-full mx-auto bg-white shadow-md rounded-lg">
      ...
      <button onClick={() => navigate('/authors/add')} className="bg-blue-500 text-white px-4 py-2 rounded mb-4">
        Thêm Nhà Tác Giả
      </button>
          ...
          {authors.map(aut => (
            <tr key={aut.id} className="border">
              ...
              <td className="border p-2 flex gap-2 justify-center">
                ...
                <button onClick={() => navigate(`/authors/edit/${aut.id}`)} className="bg-yellow-500 text-white px-2 py-1 rounded">Sửa</button>
